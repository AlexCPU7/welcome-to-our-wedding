  ...
  schedule: [
    {
      ...
      title: 'Сбор гостей на свадебную регистрацию',
      place: 'Музей-заповедник «Царицыно», Оперный дом',
      note: 'Встречаемся перед началом церемонии.',
    },
    {
      time: '14:30',
    ...
    },
    {
      ...
      place: 'Ресторан Lauren Parker',
      note: 'Встречаемся в ресторане, общаемся и настраиваемся на вечер. Просим взять с собой хорошее настроение и свои улыбки.',
    },
    {
      time: '17:00',
