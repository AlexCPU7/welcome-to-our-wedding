...
export const wedding = {
  ...
  banquet: {
    ...
    place: 'Ресторан Рублевка Вилладж',
    address: 'Поселок Горки-10, 10/3',
    ...
    photoAlt: 'Ресторан Рублевка Вилладж',
    maps: makeMapLinks('Рублевка Вилладж поселок Горки-10, 10/3'),
  },
  schedule: [
    {
      time: '14:00',
      title: 'Сбор гостей на свадебную регистрацию',
      place: 'Музей-заповедник «Царицыно», Оперный дом',
      note: 'Встречаемся перед началом регистрации в ЗАГС',
    },
    {
      time: '14:30',
    ...
    },
    {
      time: '16:30',
      title: 'Сбор гостей, фуршет, welcome-встреча',
      place: 'Встречаемся в ресторане Рублевка Вилладж, общаемся и настраиваемся на вечер',
